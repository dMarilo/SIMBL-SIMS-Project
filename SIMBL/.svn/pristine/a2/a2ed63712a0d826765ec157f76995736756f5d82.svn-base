...
public class PopupMenuPovrsinaZaCrtanje extends JPopupMenu {
	...
	listeners.UredjivanjeMenuActionListener actionListener = null;
	
	@SuppressWarnings("deprecation")
	public PopupMenuPovrsinaZaCrtanje() {
		
		actionListener = new listeners.UredjivanjeMenuActionListener();
		...
		menuItemPonistiPrethodniKorak.setIcon(Helper.getIconFromName("arrow_undo"));
		...
		menuItemPovratiPonisteniKorak.setIcon(Helper.getIconFromName("arrow_redo"));
		...
		menuItemIsjecanje.setIcon(Helper.getIconFromName("cut"));
		...
		menuItemKopiranje.setIcon(Helper.getIconFromName("clipboard_text"));
		...
		menuItemLijepljenje.setIcon(Helper.getIconFromName("clipboard_paste_image"));
		...
		menuItemObrisiOznaceneElemente.setIcon(Helper.getMyIconFromName("eraser"));
		...
		menuItemUrediElement.setIcon(Helper.getMyIconFromName("edit"));
